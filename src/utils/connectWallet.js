...
export const injected = new InjectedConnector({ supportedChainIds: [PRIMARY_CHAIN_ID] })
...
export function useConnectedWallet() {
  ...
  const contract = library && account && new IconicIndexContract(library.getSigner(account));
